...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PhotoRoomApi.AccountDetails200ResponseCredits();
  });
  ...
  describe('AccountDetails200ResponseCredits', function() {
    it('should create an instance of AccountDetails200ResponseCredits', function() {
      // uncomment below and update the code to test AccountDetails200ResponseCredits
      //var instance = new PhotoRoomApi.AccountDetails200ResponseCredits();
      //expect(instance).to.be.a(PhotoRoomApi.AccountDetails200ResponseCredits);
    });
