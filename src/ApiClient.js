...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://beta-sdk.photoroom.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://beta-sdk.photoroom.com
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://beta-sdk.photoroom.com",
              'description': "Production server with beta features",
            },
            {
